...
function Contact() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-white-50 px-4 lg:px-28 sm:px-3 md:px-6 xl:px-32 2xl:px-30">
      <div className="flex flex-col justify-center items-center pt-12 w-full">
        <div className="w-full">
          ...
          <div className="w-full bg-white rounded-md shadow p-1.5">
            <iframe
              ...
              className="w-full rounded-md h-[300px] sm:h-[350px] md:h-[400px]"
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
